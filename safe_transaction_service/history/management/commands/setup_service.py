...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.GTON_TESTNET: [
        ("0xEa65c30b14570BD14Fb4DA580Ce869A026DC0B46", 29, "1.3.0+L2"),
        ("0xD4Ff94D3D4b4d8a569A7fB86E2f6086295FBd4De", 30, "1.3.0"),
    ],
}
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.GTON_TESTNET : [
        ("0xDDDeD48359f2A37a6c4048DA3F0472E5B62db27a", 21),  # v1.3.0
    ],
}
